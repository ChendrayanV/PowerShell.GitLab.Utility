function Get-PSGitLabProject {
  ...
  param (
    ...
    [Parameter(Mandatory, ValueFromPipeline, ValueFromPipelineByPropertyName, ParameterSetName = 'Project', HelpMessage = 'Full Path of the Project - Example: Group/Project', Position = 2)]
    [string[]]
    $ProjectFullPath,

    [Parameter(Mandatory, ParameterSetName = 'Group', ValueFromPipeline, ValueFromPipelineByPropertyName, Position = 2)]
    $GroupFullPath
  )
